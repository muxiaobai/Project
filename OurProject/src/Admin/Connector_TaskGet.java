...
/**
 * Servlet implementation class Connector_TaskGet
 */
@WebServlet("/Connector_TaskGet")
public class Connector_TaskGet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Connector_TaskGet() {
        super();
