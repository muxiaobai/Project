...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">部门管理</strong> / <small>Govnmt management</small></div>
    </div>
    ...
    <div class="am-g">
      <div class="am-u-md-6 am-cf">
       ...
       <div class="am-g am-margin-top">
          ...
          <a href="../html/DepartmentAdd.html"><span class="am-icon-plus-square" >  添加部门</span></a>
         </div>
         </div>
...
<c:otherwise>
	...
	<table class="table table-hover  table-striped ">
	    ...
	    <tbody>
	<c:forEach var="department" items="${DaoFactory.getDepartmentDaoInstance().findAll('')}">


        <tr>
        <td>${department.department_id}</td> 
        <td>${department.department_name}</td>    
         <td>${department.department_remark}</td> 
         <td>
         <c:choose>
<c:when test="${department.department_state==1}">
新增部门未审核
  </td> 
          <td>等待审核</td>    
      
</c:when>
<c:when test="${department.department_state==2}">
已通过创建<td><a href="../../DepartmentState?department_id=${department.department_id}&department_state=3&my=1">删除</a></td>
</c:when>
<c:when test="${department.department_state==3}">
删除信息已提交</td> 
          <td>等待审核</td>    
  
</c:when>
<c:when test="${department.department_state==4}">
删除信息提交失败
</c:when>
<c:otherwise>
</c:otherwise>
