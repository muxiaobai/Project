...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">部门管理</strong> / <small>department management</small></div>
    </div>
...
新增部门未审核
          ...
          <td><a href="../../DepartmentState?department_id=${department.department_id}&department_state=2&my=2">通过</a></td>    
...
删除信息已提交</td> 
          <td><a href="../../DepartmentDelete?department_id=${department.department_id}">通过</a></td>    
