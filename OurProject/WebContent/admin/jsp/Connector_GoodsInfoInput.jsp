...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-g">
    <form  class="am-form" action="../../Connector_GoodsInfoInput" method="post">
      <div class="am-u-sm-6">

		<label>大类别: </label><select name="dalei" id="dalei">
		     <option selected>请选择</option>
			<%
				Tool.Menu op = new Tool.Menu();
				out.println(op.getcanton());
			%>
		</select><label>小类别: </label><select name="xiaolei" id="xiaolei">
			<option selected value="">请选择</option>
		</select><label>产品: </label><select name="pinzhong" id="pinzhong">
			<option selected value="">请选择</option>
		</select> 
		
		<label>本地市场价格</label><input type=text name="inprice" class="form-control" placeholder=""/>元<br/>
		<label>外地市场价格</label><input type=text name="outprice" class="form-control" placeholder=""/>元<br/>
		<label>其他内容</label><textarea cols="10" rows="5" name="otherinfo_text"></textarea>
